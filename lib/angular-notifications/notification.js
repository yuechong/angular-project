...
angular.module('notifications', []).
  factory('$notification', ['$timeout',function($timeout){
    ...
    return {
      ...
      info: function(title, content, userData){//circle info icon
        console.log(title, content);
        return this.awesomeNotify('info','circle info icon', title, content, userData);
      },

      error: function(title, content, userData){//remove circle icon
        return this.awesomeNotify('error', 'remove circle icon', title, content, userData);
      },

      success: function(title, content, userData){//check circle icon 
        return this.awesomeNotify('success', 'check circle icon', title, content, userData);
      },

      warning: function(title, content, userData){// warning circle icon 
        return this.awesomeNotify('warning', 'warning circle icon', title, content, userData);
      },
